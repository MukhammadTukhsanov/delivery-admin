      ...
      <div className='relative flex flex-col flex-auto items-center p-6 pt-0 sm:p-12 sm:pt-0'>
        <div className='w-full max-w-5xl'>
          <div className='flex flex-auto items-end -mt-16'>
            ...
            <Grid marginLeft={4} container spacing={2} justifyContent='flex-end'>
              <Grid size={{ md: 6 }}>
                <Button
                  fullWidth
                  variant='contained'
                ...
                >
                  ...
                  <span className='mx-2'>Statistika</span>
                </Button>
              </Grid>
              <Grid size={{ md: 6 }}>
                <Button
                ...
                >
                  <FuseSvgIcon size={20}>heroicons-outline:shopping-cart</FuseSvgIcon>
                  <span className='mx-2'>Buyurtmalar</span>
                </Button>
              </Grid>
              <Grid size={{ md: 6 }}>
                <Button
                ...
                >
                  ...
                  <span className='mx-2'>Maxsulotlar</span>
                </Button>
              </Grid>
              <Grid size={{ md: 6 }}>
                <Button
                ...
                >
                  ...
                  <span className='mx-2'>Tahrirlash</span>
                </Button>
              </Grid>
            </Grid>
          </div>
