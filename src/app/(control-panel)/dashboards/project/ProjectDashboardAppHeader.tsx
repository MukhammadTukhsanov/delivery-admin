      ...
      <div className='flex flex-col sm:flex-row flex-auto sm:items-center min-w-0 my-8 sm:my-12'>
        <div className='flex flex-auto items-center min-w-0'>
          ...
          <div className='flex flex-col min-w-0 mx-4'>
            ...
            {/* <div className='flex items-center'>
              ...
              <Typography className='mx-1.5 leading-6 truncate' color='text.secondary'>
        ...
        <div className='flex items-center mt-6 sm:mt-0 sm:mx-2 space-x-2'>
          <Button
            ...
            variant='contained'
            color='primary'
            startIcon={<FuseSvgIcon size={20}>heroicons-solid:user</FuseSvgIcon>}
          >
            Foydalanuchilar
          </Button>
          <Button
            ...
            variant='contained'
            color='secondary'
            startIcon={<FuseSvgIcon size={20}>heroicons-solid:shopping-cart</FuseSvgIcon>}
          >
            Sotuvchilar
          </Button>
        </div>
