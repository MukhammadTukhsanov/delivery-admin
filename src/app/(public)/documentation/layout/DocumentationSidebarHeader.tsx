...
function DocumentationSidebarHeader(props: DocumentationSidebarHeaderProps) {
  ...
  return (
    <div className={clsx('flex items-center space-x-2', className)}>
      <img className='logo-icon h-8 w-8' src='/assets/images/logo/logo.svg' alt='logo' />
      <div className='logo-text flex flex-col flex-auto'>
        ...
        <Typography className='text-xl tracking-light font-bold leading-none' color='primary'>
          DOCS
        </Typography>
      </div>
